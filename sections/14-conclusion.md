...
a certain number of words. The cost of {% include columnbreak.html page=183 col=2 %} printing that number of words is calculated 
...
that the first cost appears only as a negligible item in the total. In microcopying {% include pagebreak.html page=184 %} short items to order, as in the Bibliofilm 
...
copy. Running costs for 100 copies, stated as percentages of the first cost in minimum edition, stand as follows: {% include columnbreak.html col=2 %}
...
edition will the unit costs be so compounded that only 10% of the cost of a copy is {% include pagebreak.html page=185 %}
...
edition?" The edition sizes for the various processes would then stand as follows: {% include columnbreak.html page=185 col=2 %} On the chart (Table LII, on the 
...
equal. {% include columnbreak.html %} with data taken from the tables in foregoing chapters. The curves for printing, 
...
that are obtainable are secured before the {% include pagebreak.html page=186 %}
...
above photostat. If 2000 copies are needed, most of the cost advantages of microcopying disappear. {% include columnbreak.html %}
...
efficiency point is that of the hectograph {% include pagebreak.html page=187 %}
...
a manufacturing cost that will permit the {% include columnbreak.html page=187 col=2 %} distribution of books at prices that would 
...
They will often wish to have a unique copy {% include pagebreak.html page=188 %}
...
Moreover, it is possible that a {% include columnbreak.html %} scholar might wish to make more than one 
...
the reproduction of the book or typescript {% include pagebreak.html page=189 %} of 100,000 words begins always with one of 
...
sole technique by which the materials and {% include columnbreak.html %} products of research are to be reproduced. 
...
notably the hectograph, operate at so low a {% include pagebreak.html page=190 %}
...
{% include pagebreak.html page=191 %} cost level that the author himself can absorb the cost of production and the risk of 
...
given out by Dr. Watson Davis in the following circular to the editors of scientific publications. {% include columnbreak.html page=191 col=2 %}
...
> The operation of this plan of 
    ...
    it when, how, and if it is helpful. We {% include pagebreak.html page=192 %} ask no financial participation or 
...
Science Service. {% include columnbreak.html page=192 col=2 %}
...
{% include pagebreak.html page=193 %} That this cooperative agreement 
...
mechanical sales routine. {% include columnbreak.html page=193 col=2
 %}
...
of orders which they receive each day is {% include pagebreak.html page=194 %} constantly increasing. At the present time 
...
Congress has been a promotor of a large-scale plan for rearranging and rationalizing book holdings of American libraries. {% include columnbreak.html page=194 col=2 %} One part of his plan called for the multiplying of rare books. The idea that the 
...
of buyers---whether it be ten or ten thousand. {% include pagebreak.html page=195 %}
...
they need not cause concern. The next prob{% include columnbreak.html page=195 col=2 %}lem is one of institutional development and 
...
risk. While they have been developed in {% include pagebreak.html page=196 %} connection with the technique of printing, 
...
inaccessible brought to him, and that he {% include columnbreak.html page=196 col=2 %} may be able to communicate to his colleagues 
...
should operate to expand and dignify the {% include pagebreak.html page=197 %} role of the collector, and at the same time 
...
in the attitudes of the scholars themselves. {% include columnbreak.html page=197 col=2 %} Too often there is a veneration of book 
...
certain classes of books and periodicals, {% include pagebreak.html page=198 %} and even of newspapers and some kinds of 
...
{% include columnbreak.html page=198 col=2 %} We are not yet intellectually prepared to develop these human resources. We 
...
technique of microcopying provides {% include pagebreak.html page=199 %} inter-library service. The union catalogue 
...
put the material into near-print form for {% include columnbreak.html page=199 col=2 %} the sake of the intangible reward of scholarly recognition. The newspaper digest is 
...
uses better understood, it will follow that {% include pagebreak.html page=200 %} people who are not close to large libraries 
...
prior to the introduction of NRA and a period subsequent thereto. Most American business firms have already destroyed the orig{% include columnbreak.html page=200 col=2 %}inal pay rolls, materials cards, work cards, 
...
The restricted space in which the {% include pagebreak.html page=201 %} modern family lives, and the frequent moving from apartment to apartment that becomes normal in urban civilization, make 
...
The development of simplified re{% include columnbreak.html page=201 col=2 %}search techniques in the social studies and 
...
be surprised at the conclusion that a technological revoluntion has in it the seeds of 
a cultural revolution. Such may indeed be 
true in this instance. The cultural revival of the small town as against the monopoly of the metropolis, and the democratization {% include pagebreak.html page=202 %} and "deprofessionalization" of scholarship 
...
decline in the centralization of population in cities and the development of a {% include columnbreak.html page=202 col=2 %} new leisure in the hands of a well-educated people. The same technical innovations that promise to give aid to the research worker in his cubicle may also 
